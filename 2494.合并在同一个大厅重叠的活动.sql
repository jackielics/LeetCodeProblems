...
-- 避免重复，H1的start_day在H2的start_day和end_day之间
        AND (
            (H2.start_day BETWEEN H1.start_day AND H1.end_day)
        AND (H1.start_day BETWEEN H2.start_day AND H2.end_day)
        )
}
/* , Hall_not_null AS
{SELECT  hall_id, 
